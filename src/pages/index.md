...
economy:
  ...
  upperText: >-
    ...
    Although the tools, techniques and technology are always evolving the
    problem solving and hands on experience, aspects to the craft remain the
    same. 


    Maker Spaces provide the tools, education and technology for the inventors
    of today. 


    Below are a few industry facts & figures.
faq:
